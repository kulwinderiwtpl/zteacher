        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="type" required lay-verify="required" autocomplete="off"
                       class="layui-input add-input" value="{{ $consumption['type'] }}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tier1" required lay-verify="required" autocomplete="off"
                       class="layui-input add-input" value="{{ $consumption['tier1'] }}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="tier2" required lay-verify="required" autocomplete="off"
                       class="layui-input add-input" value="{{ $consumption['tier2'] }}">
            </div>
        </div>
...
{!! Theme::asset()->container('custom-js')->usePath()->add('upConsumption', 'zhuojiao/js//English/upConsumption.js') !!}