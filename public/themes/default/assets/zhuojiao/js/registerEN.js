var img_url3 = "";//headImage 的 value
...
var img_url2 = "";//headImage 的 value
...
var img_url1 = "";//headImage 的 value
    ...
    upload.render({
        ...
        accept: 'file', //普通文件
            ...
            if (data.code == 100) {
                ...
                layer.msg('Failed to upload, please check whether the uploaded file is correct');
            }
        }
    });
});