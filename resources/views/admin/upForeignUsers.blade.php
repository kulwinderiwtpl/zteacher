...
<h3 class="header smaller lighter blue mg-top12 mg-bottom20">编辑国外用户资料</h3>


<form class="form-horizontal clearfix registerform" role="form" action="{!! url('manage/upForeignUsers') !!}" method="post">
    {!! csrf_field() !!}
