...
//        $this->initTheme('main');
    ...
    public function login()
    {
        ...
        $this->theme->set('title', '登录');
        return $this->theme->scope('Chinese.User.login',['email' => $email])->render();
    }
...
//            return $this->theme->scope('Chinese.User.retrievePassword')->render();
    ...
    public function publish()
    {
        ...
        $this->initTheme('zTeachers');
        $this->theme->set('title', '发布工作');
        return $this->theme->scope('Chinese.publish', ['edit' => $edit])->render();
    }
