...
<form class="form-horizontal" action="/manage/{{ $postUrl }}?url={{ $url }}" method="post" enctype="multipart/form-data" id="ad">
    {{ csrf_field() }}
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="col-xs-10 col-sm-5" type="text" name="introduce" datatype="*" nullmsg="请填写介绍！"
                                   value="{!! isset($data)?$data->introduce : '' !!}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <textarea name="content" cols="40" datatype="*" nullmsg="请填写内容！"
                                      rows="3">{!! isset($data)?$data->content : '' !!}</textarea>
