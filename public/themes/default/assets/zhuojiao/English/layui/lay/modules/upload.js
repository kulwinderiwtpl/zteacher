...
;layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            ...
            layui.each(a, function (e, a) {
                ...
                r.append(l.field, a), layui.each(l.data, function (e, i) {
                    ...
                    error: function () {
                        n++, o.msg("An exception occurred in the request upload interface"), m(e), u()
                    }
                })
            })
        }, c = function () {
            ...
            o.elemFile.parent().submit(), clearInterval(p.timer), p.timer = setInterval(function () {
                ...
                try {
                    ...
                    o.msg("There is an exception in getting the response information after uploading"), clearInterval(p.timer), m()
                }
            ...
            if (o.elemFile.next("." + s).remove(), r.value = "", "object" != typeof i) try {
                ...
                return i = {}, o.msg("Please return valid JSON for the upload interface")
            }
        ...
        if (v = 0 === v.length ? r.value.match(/[^\/\\]+\..+/g) || [] || "" : v, 0 !== v.length) {
            switch (l.accept) {
                case"file":
                    if (h && !RegExp("\\w\\.(" + h + ")$", "i").test(escape(v))) return o.msg("The selected file contains an unsupported format"), r.value = "";
                    break;
                case"video":
                    if (!RegExp("\\w\\.(" + (h || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(v))) return o.msg("The selected video contains an unsupported format"), r.value = "";
                    break;
                case"audio":
                    if (!RegExp("\\w\\.(" + (h || "mp3|wav|mid") + ")$", "i").test(escape(v))) return o.msg("The selected audio contains an unsupported format"), r.value = "";
                    break;
                default:
                    if (layui.each(v, function (e, i) {
                            RegExp("\\w\\.(" + (h || "jpg|png|gif|bmp|jpeg$") + ")", "i").test(escape(i)) || (n = !0)
                        }), n) return o.msg("The selected image contains an unsupported format"), r.value = ""
            }
            if (o.fileLength = function () {
                ...
                }(), l.number && o.fileLength > l.number) return o.msg("At the same time, the maximum number of uploads can be：" + l.number);
            if (l.size > 0 && !(a.ie && a.ie < 10)) {
                ...
                if (layui.each(o.chooseFiles, function (e, i) {
                    ...
                    }), F) return o.msg("Files cannot exceed" + F)
            }
            y()
        }
        ...
        var e = this, t = e.config, o = function (i) {
            ...
            var a = e.elemFile,
                o = i.length > 1 ? i.length + "files" : (i[0] || {}).name || a[0].value.match(/[^\/\\]+\..+/g) || [] || "";
