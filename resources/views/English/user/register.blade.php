...
<div class="container padding0">
    <div class="container padding0 titleBox">
        ...
        <img class="deco" src="{{asset('themes/default/assets/zhuojiao/English/images/deco.png') }}" alt="">
    </div>
...
<link rel="stylesheet" href="{{ asset('themes/default/assets/zhuojiao/English/layui/css/layui.css') }}">
<link rel="stylesheet" href="{{ asset('themes/default/assets/zhuojiao/English/css/register.css') }}">
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
<script src="{{ asset('themes/default/assets/zhuojiao/English/js/distpicker.data.js') }}"></script>
<script src="{{ asset('themes/default/assets/zhuojiao/English/js/distpicker.js') }}"></script>

<script src="{{ asset('themes/default/assets/zhuojiao/English/js/main.js') }}"></script>
<script src="{{ asset('themes/default/assets/zhuojiao/English/js/upload.js') }}"></script>

<script src="{{ asset('themes/default/assets/zhuojiao/English/layui/layui.js') }}"></script>
<script src="{{ asset('themes/default/assets/zhuojiao/js/registerEN.js') }}"></script>
