...
<div class="navbar-header pull-left">
    ...
    <a href="/manage"
       class="navbar-brand">{{--<img style="width: 81px;height: 27px;" src="{{url('/themes/default/assets/beer/img/logo.png')}}">--}}
    </a>
    ...
    <ul class="nav ace-nav">
        ...
        <li class="light-blue">
            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                {{--<img class="nav-user-photo" src="{{ asset('themes/admin/assets/plugins/ace/avatars/user.jpg') }}" alt="Jason's Photo" />--}}
                <img class="nav-user-photo" src="{{ asset('themes/admin/assets/images/default_avatar.png') }}"
                     alt="Jason's Photo"/>
