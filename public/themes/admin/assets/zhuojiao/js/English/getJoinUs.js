$(function () {
    layui.use('layedit', function () {
        ...
        layedit.build('edit1', { //Register 编辑器
            height: 150,
            tool: [],
        });
        layedit.build('edit2', { //Hiring Process 编辑器
            height: 150,
            tool: [],
        });
...
//栏目标题编辑
$("#joinusEnglishversionTitleEdit").click(function () {
    window.location.href = "/manage/EnglishVersion/aboutusTitle/6";
})