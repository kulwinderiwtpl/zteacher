...
<form class="form-horizontal" action="/manage/upEngage" method="post" enctype="multipart/form-data" id="ad">
    {{ csrf_field() }}
            ...
            <div class="g-backrealdetails clearfix bor-border">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="col-xs-10 col-sm-5" type="text" name="title" datatype="*" nullmsg="请填写标题！"
                                   value="{!! isset($engage)?$engage->title : '' !!}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input class="col-xs-10 col-sm-5" type="text" name="introduce" datatype="*" nullmsg="请填写介绍！"
                                   value="{!! isset($engage)?$engage->introduce : '' !!}">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <textarea name="content" cols="40" datatype="*" nullmsg="请填写内容！"
                                      rows="3">{!! isset($engage)?$engage->content : '' !!}</textarea>
