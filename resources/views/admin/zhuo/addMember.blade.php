<div class="chamberCommercelist-content">
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="padding-top: 10px;">
                <input type="radio" name="is_chain" value="1" title="是" checked>
                <input type="radio" name="is_chain" value="0" title="否">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">有无办理教学签证资质：</label>
            <div class="layui-input-block" style="padding-top: 10px;">
                <input type="radio" name="is_qualification" value="1" title="有" checked>
                <input type="radio" name="is_qualification" value="0" title="无">
            </div>
        </div>
        <div class="layui-form-item">
...
{!! Theme::asset()->container('custom-js')->usePath()->add('getMember', 'zhuojiao/js/English/addMember.js') !!}