...
class TalentPoolController extends ManageController
{
    ...
    {
        $users = ResumeModel::orderBy('created_at', 'DBSC')->paginate(10);
        ...
        return $this->theme->scope('zhuo.talentPool', $view)->render();
    }
