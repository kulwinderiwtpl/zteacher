...
class ContentNavEnglishController extends Controller
{
...
//     }
    ...
    public function getAbouts()
    {
        ...
        return view('admin.zhuo.English.aboutUs', $view)->render();
    }
...
//        var_dump($navs);die;
    ...
    public function getJoinUs()
    {
        ...
        return view('admin.zhuo.English.getJoinUs', $view);
    }
    ...
    public function getBenefits()
    {
        ...
        return view('admin.zhuo.English.getBenefits', $view);
    }
    ...
    public function getLifeInChina()
    {
        ...
        //$this->theme->setTitle('Benefits');
        return view('admin.zhuo.English.getLifeInChina', $view);
    }
    ...
    public function getWorkingInChina()
    {
       ...
       // $this->theme->setTitle('working in China');
        return view('admin.zhuo.English.getWorkingInChina', $view);
    }
