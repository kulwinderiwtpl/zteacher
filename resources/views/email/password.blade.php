    ...
    <div class="container">
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <p>您好 <A data-auto-link=1 href="mailto:{!! $mail['to'] !!}"> {!! $mail['to'] !!}</A>！</p>
                <p>
                    您已经请求了重置密码，可以点击下面的链接来重置密码。
                </p>
                <p>
                    <a href="{!! url('password/edit?email='.urlencode($mail['to']).'&reset_password_token='.$mail['reset_password_token']) !!}">{!! url('password/edit?email='.urlencode($mail['to']).'&reset_password_token='.$mail['reset_password_token']) !!}</a>
                </p>
                <p>{{--如果您没有请求重置密码，请忽略这封邮件。--}}该链接12小时内有效，12小时后需要重新验证，如若不是您发送的邮件，请检查您的账号</p>
