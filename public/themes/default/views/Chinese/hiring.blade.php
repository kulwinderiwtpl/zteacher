...
<div class="container contentWarp">
    ...
    <img class="deco deco2 hidden-sm hidden-lg hidden-md" src="{{ url('/themes/default/assets/zhuojiao/images/deco.png') }}" alt="">
    ...
    <div class="rightContent2" style="float: left">
        ...
        <img class="deco deco2 hidden-xs" src="{{ url('/themes/default/assets/zhuojiao/images/deco.png') }}" alt="">
...
<div class="container-fluid padding0">
    <img class="blank_banner" src="{{ url('/themes/default/assets/zhuojiao/images/pqwj_2.png') }}" alt="">
</div>
<div class="container padding0 titleBox">
...
<div class="container contentWarp">
    <img class="Delete treatment hidden-xs" src="{{ url('/themes/default/assets/zhuojiao/images/pqwj_3.png') }}" alt="">
    <div class="rightContent2">
        <div class="title title2">{{ $treatment['title'] }}</div>
        <img class="deco deco2" src="{{ url('/themes/default/assets/zhuojiao/images/deco.png') }}" alt="">
        <div style="clear: both"></div>
        <div class="content2">
...
{!! Theme::asset()->container('custom-css')->usepath()->add('hiring','zhuojiao/css/hiring.css') !!}
